...
namespace vmpc_juce::gui::vector
{
    ...
    static void from_json(const nlohmann::json &j, node &n)
    {
        if (j.contains("include"))
        {
            const auto jsonFileData =
                vmpc_juce::VmpcJuceResourceUtil::getResourceData(
                    "json/" + j.at("include").get<std::string>() + ".json");
        ...
        else
        {
            ...
            if (j.contains("label_style"))
            {
                j.at("label_style").get_to(n.label_style);
            }
            if (j.contains("direction"))
            {
                j.at("direction").get_to(n.direction);
            }
            if (j.contains("flex_grow"))
            {
                j.at("flex_grow").get_to(n.flex_grow);
            }
            else
            {
                n.flex_grow = 0.f;
            }
            if (j.contains("align_items"))
            {
                j.at("align_items").get_to(n.align_items);
            }
            if (j.contains("row_fractions"))
            {
                j.at("row_fractions").get_to(n.row_fractions);
            }
            if (j.contains("column_fractions"))
            {
                j.at("column_fractions").get_to(n.column_fractions);
            }
            if (j.contains("area"))
            {
                j.at("area").get_to(n.area);
            }
            if (j.contains("justify_items"))
            {
                j.at("justify_items").get_to(n.justify_items);
            }
            if (j.contains("width"))
            {
                j.at("width").get_to(n.width);
            }
            if (j.contains("hide_svg"))
            {
                j.at("hide_svg").get_to(n.hide_svg);
            }
            else
            {
                n.hide_svg = false;
            }
            if (j.contains("is_inner_shadow"))
            {
                j.at("is_inner_shadow").get_to(n.is_inner_shadow);
            }
            else
            {
                n.is_inner_shadow = false;
            }
            if (j.contains("magic_multiplier"))
            {
                j.at("magic_multiplier").get_to(n.magic_multiplier);
            }
            else
            {
                n.magic_multiplier = 0.f;
            }
            if (j.contains("hardware_label"))
            {
                j.at("hardware_label").get_to(n.hardware_label);
            }
            if (j.contains("svg_placement"))
            {
                j.at("svg_placement").get_to(n.svg_placement);
            }
            if (j.contains("font_scale"))
            {
                j.at("font_scale").get_to(n.font_scale);
            }
            else
            {
                n.font_scale = 0.f;
            ...
            if (j.contains("font"))
            {
                j.at("font").get_to(n.font);
            }
            if (j.contains("base_width"))
            {
                j.at("base_width").get_to(n.base_width);
            }
            else
            {
                n.base_width = 0.f;
            }
            if (j.contains("base_height"))
            {
                j.at("base_height").get_to(n.base_height);
            }
            else
            {
                n.base_height = 0.f;
            ...
            {
                j.at("label_text_to_calculate_width")
                    .get_to(n.label_text_to_calculate_width);
            }
        ...
        if (!n.area.empty())
        {
            // JUCE's withArea(rowStart, columnStart, rowEnd, columnEnd) API
            // expects exclusive rowEnd and columnEnd arguments. I find that
            // unintuitive, so in the layouts I specify inclusive end arguments,
            // and do a fix-up here.
            n.area[2] += 1;
            n.area[3] += 1;
        }
        ...
        if (!n.label_style.empty())
        {
            printf("- label_style: %s\n", n.label_style.c_str());
        }
        if (n.flex_grow != 0.f)
        {
            printf("-   flex_grow: %f\n", n.flex_grow);
