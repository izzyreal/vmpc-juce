...
namespace vmpc_juce::gui::vector
{
    ...
    {
    private:
        template <typename Iterator> class DereferencingIterator
        {
        public:
            using value_type =
            ...
            explicit DereferencingIterator(Iterator in)
                : iterator(std::move(in))
            {
            }
            ...
            friend DereferencingIterator operator+(DereferencingIterator i,
                                                   difference_type d)
            {
                return i += d;
            }
            friend DereferencingIterator operator+(difference_type d,
                                                   DereferencingIterator i)
            {
                return i += d;
            }
            ...
            friend bool operator<(DereferencingIterator a,
                                  DereferencingIterator b)
            {
                return a.iterator < b.iterator;
            }
            ...
            {
                DereferencingIterator copy(*this);
                ++(*this);
                return copy;
            }
            DereferencingIterator operator--(int) const
    ...
    public:
        ...
        void createLayoutWithBalancedLineLengths(const juce::AttributedString &,
                                                 float maxWidth);
        ...
        {
        public:
            Glyph(int glyphCode, juce::Point<float> anchor,
