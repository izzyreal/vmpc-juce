...
juce::Colour Constants::greyFacePaintColour =
    juce::Colour::fromRGB(139, 151, 163);
juce::Colour Constants::betweenChassisAndLabelColour =
    chassisColour.darker(0.2f);

juce::Colour Constants::lcdOn =
    juce::Colour::fromRGB(86, 61, 135).darker().darker();
juce::Colour Constants::lcdOnLight = Constants::lcdOn.brighter(0.8f).darker();
// juce::Colour Constants::lcdOffBacklit = juce::Colour::fromRGB(170, 225,
// 180).brighter(0.f);
