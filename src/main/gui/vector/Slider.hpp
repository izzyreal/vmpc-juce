...
namespace vmpc_juce::gui::vector
{
    ...
    public:
        ...
        void resized() override
        {
            ...
            sliderCap->setSize(static_cast<int>(width),
                               static_cast<int>(height));
            sliderCap->setTopLeftPosition(
        ...
        void paint(juce::Graphics &g) override
        {
            auto transform = juce::AffineTransform::scale(
                0.975f, 0.975f, (float)getWidth() * 0.5f,
            ...
            for (int i = 0; i < lineCount; i++)
            {
                ...
                g.drawLine((float)width - line_length, y_pos, (float)width,
                           y_pos, line_thickness);
            }

            auto notch_rect =
                getLocalBounds().toFloat().reduced((float)width * 0.465f, 2.f);
