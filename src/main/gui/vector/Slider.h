...
#include "gui/vector/DraggableSvgComponent.h"
...
class Slider: public juce::Component {
    public:
        ...
        {
            sliderCapSvg = new DraggableSvgComponent({"slider_cap.svg"}, this, 5, getScale);
        ...
        void resized() override
        {
            ...
            sliderCapSvg->setSize(width, height);
            sliderCapSvg->setTopLeftPosition(getLocalBounds().getCentreX() - (width *0.5f), 50);
        }
