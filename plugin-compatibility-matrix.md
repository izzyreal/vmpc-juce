...
* I have seen occasional absence of keyboard input. This seems to happen due to some issue related to window focus. Close and reopen the plugin window to work around this. Update: This has now apparently been resolved by [increasing the delay before grabbing keyboard focus](https://github.com/izzyreal/vmpc-juce/blob/cc6b184e72ec6ef1ad4a09c15f61b91bb6b31236/src/main/VmpcEditor.cpp#L77C5-L77C13).
